...
export default class CylinderVert {
    ...
    render(grm) {
        ...
        for (let seg = 0; seg < this._segments; seg++) {
            ...
            _reusableTriArray[1] = 1;
            _reusableTriArray[2] = 0;
            _reusableTriArray[3] = x1;
            _reusableTriArray[4] = 1;
            _reusableTriArray[5] = z1;
            _reusableTriArray[6] = x2;
            _reusableTriArray[7] = 1;
            _reusableTriArray[8] = z2;
            ...
            _reusableTriArray[1] = -1;
            _reusableTriArray[2] = z1;
            _reusableTriArray[3] = x2;
            _reusableTriArray[4] = -1;
            _reusableTriArray[5] = z2;
            _reusableTriArray[6] = x1;
            _reusableTriArray[7] = 1;
            _reusableTriArray[8] = z1;
            drawTriangle(grm, _reusableTriArray, TRASH_UV_COORDS);
            _reusableTriArray[0] = x2;
            _reusableTriArray[1] = 1;
            _reusableTriArray[2] = z2;
            _reusableTriArray[3] = x1;
            _reusableTriArray[4] = 1;
            _reusableTriArray[5] = z1;
            _reusableTriArray[6] = x2;
