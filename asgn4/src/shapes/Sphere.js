...
export default class Sphere {
    ...
    render(grm) {
        ...
        for (const tri of this._triangles) {
            _reusableTriArray[0] = tri[0];
            _reusableTriArray[1] = tri[1];
            _reusableTriArray[2] = tri[2];
            _reusableTriArray[3] = tri[3];
            _reusableTriArray[4] = tri[4];
            _reusableTriArray[5] = tri[5];
            _reusableTriArray[6] = tri[6];
            _reusableTriArray[7] = tri[7];
            _reusableTriArray[8] = tri[8];
